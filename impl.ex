defmodule GameOfStones.Server.Impl do
  ...
  num_stones > current_stones do
    {
      ...
      {
        :error,
        "You can take from 1 to 3 stones, and it should execeed the total count of stones!"
...
new_stones = current_stones - num_stones
  ...
  {:reply,
  {:next_turn, next_p, new_stones}, {next_p, new_stones}, # response to the client
